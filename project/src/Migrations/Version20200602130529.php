 ...
 */
final class Version20200602130529 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD latitude NUMERIC(20, 16) DEFAULT NULL, ADD longitude NUMERIC(20, 16) DEFAULT NULL');
